...
namespace Dinewell.DataAccess.Migrations
{
    ...
    partial class DinewellContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.LogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantMenuImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantSide", b =>
                {
                    ...
                    b.ToTable("RestaurantSides");
                });

            modelBuilder.Entity("Dinewell.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RoleUseCase", b =>
                {
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.OrderMeal", b =>
                {
                    b.HasOne("Dinewell.Domain.Entities.RestaurantMenu", "Meal")
                        .WithMany("OrderMeals")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantImage", b =>
                {
                    b.HasOne("Dinewell.Domain.Entities.Restaurant", "Restaurant")
                        ...
                        .HasForeignKey("Dinewell.Domain.Entities.RestaurantImage", "RestaurantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantMenuImage", b =>
                {
                    b.HasOne("Dinewell.Domain.Entities.RestaurantMenu", "RestaurantMenu")
                        .WithOne("RestaurantMenuImage")
                        .HasForeignKey("Dinewell.Domain.Entities.RestaurantMenuImage", "RestaurantMenuId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RoleUseCase", b =>
                {
                    b.HasOne("Dinewell.Domain.Entities.Role", "Role")
            ...
            modelBuilder.Entity("Dinewell.Domain.Entities.RestaurantMenu", b =>
                {
                    ...
                    b.Navigation("RestaurantMenuImage");
                });
