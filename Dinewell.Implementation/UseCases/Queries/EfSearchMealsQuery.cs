...
{
    public class EfSearchMealsQuery : UseCases.EfUseCase, ISearchMealsQuery
    {
        ...
        public PagedResponse<MealSeparateDTO> Execute(MealSearch search)
        {
            ...
            response.Data = query.Skip(toSkip).Take(search.PerPage.Value).Select(x => new MealSeparateDTO
            {
                Id = x.Id,
                Name = x.Food.Name,
